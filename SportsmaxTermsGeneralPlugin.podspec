Pod::Spec.new do |s|
  ...
  s.homepage            = 'https://github.com/applicaster-plugins/SportsmaxTermsGeneralPlugin-iOS'
  s.license             = 'MIT'
  s.author              = { "cmps" => "a=roei.carmel@msapps.mobi" }
  s.source              = { :git => 'https://github.com/applicaster-plugins/SportsmaxTermsGeneralPlugin-iOS', :tag => s.version.to_s }
